...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::messages::list_agent_activities,
            ...
            commands::projects::list_project_file_index,
            ...
            commands::shell::start_shell_command,
            commands::shell::stop_shell_command,
            commands::shell::resolve_shell_directory,
